...
BEGIN
    ...
    BEGIN
        INSERT INTO @Results
        SELECT b.BookId, b.BookTitle, b.Price, b.SmallThumbnailUrl, b.IsEbook, b.isAvailable
        FROM Books b
    ...
    BEGIN
        INSERT INTO @Results
        SELECT DISTINCT b.BookId, b.BookTitle, b.Price, b.SmallThumbnailUrl, b.IsEbook, b.isAvailable
        FROM Books b
